# 📑 Dokumentasi Gabungan Kod Sumber

Dokumen ini menggabungkan semua fail kod sumber menggunakan `markitdown`.

---

## 🛠️ Fail: `boot_recovery.py`
